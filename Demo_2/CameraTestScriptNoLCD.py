...
def camera_thread():
    global yaw_angle, camera_angle, distance, state, color_code
        ...
        while True:
            ...
            if ids is not None and len(corners) > 0:
                ...
                with lock:
                    ...
                    yaw_angle = angle_degrees
                    current_color_code = color_code # You might want to calculate actual yaw from rvec
    ...
    try:
        while True:
            ...
            with lock:
                ...
                current_state = state
                current_color_code = color_code  # You would need to add this as a global variable
