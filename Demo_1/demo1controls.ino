// demo1controls.ino
// This program controls a two-wheeled robot to rotate by a set angle  
// and then move forward a specified distance using encoder feedback.  
...
float desiredPositionFeet = 8; // Set target position in feet
